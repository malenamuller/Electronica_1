...
\section{Análisis teórico del circuito}
	En la Figura \ref{darlington_tp} se muestra el circuito implementado. La resistencia $R_3$ está para que la corriente de emisor del primer transistor no vaya por completo a la base del segundo transistor, causando que éste sature.
...
\end{table}
	...
	\begin{table}[h!]
		...
		\begin{tabular}{c c c}%
			...
			$\widehat{g}_m$ & $3,60\cdot 10^{-3}S$  & $80\cdot 10^{-3}S$ \\
